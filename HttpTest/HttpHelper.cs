...
namespace HttpTest
{
    ...
    public class HttpHeadersStatus
    {
        
        public HttpHeadersStatus()
        {
    ...
    public class HttpData
    {
        ...
        public HttpHeadersStatus HeaderInfo { get; set; }
    ...
    public class HttpHelper
    {
        ...
        /// <returns></returns>
        public static HttpHeadersStatus GetHeaders(string headersStringText)
        {
            ...
            {
                HttpHeadersStatus hhs = new HttpHeadersStatus();
        ...
        public HttpHeadersStatus GetHeadersByHEAD(IPEndPoint address, string uri, params string[] httpHeadersLines)
        {
            return GetHeadersByHEAD(address, new Uri(uri), httpHeadersLines);
        }


        public HttpHeadersStatus GetHeadersByHEAD(IPEndPoint address, Uri uri, params string[] httpHeadersLines)
        {
        ...
        public HttpHeadersStatus GetHeaders(IPEndPoint address, byte[] headersData)
        {
        ...
        public HttpData GetHttpData(IPEndPoint address, byte[] headersData)
        {
            ...
            try
            {
                ...
                HttpHeadersStatus hhs = info.HeaderInfo = GetHeaders(headersStringText);
                ...
                if (info.HeaderInfo.Headers.AllKeys.Contains("Content-Length"))
                {
                    int contentLength = int.Parse(info.HeaderInfo.Headers["Content-Length"]);
                ...
                else if (info.HeaderInfo.Headers["Transfer-Encoding"] == "chunked")
                {
